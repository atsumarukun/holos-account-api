...
func (m *MockAccountUsecase) UpdateName(arg0 context.Context, arg1 string) (*dto.AccountDTO, error) {
	m.ctrl.T.Helper()
...
func (mr *MockAccountUsecaseMockRecorder) UpdateName(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateName", reflect.TypeOf((*MockAccountUsecase)(nil).UpdateName), arg0, arg1)
}
